...
def create_question(question_text, days):
    """
    Creates a question with the given question_text published the given number of days offset to now (negative for
    questions published in the past, positive for question that have yet to be published).
    :param question_text:
    :param days:
    :return:
    """
...
class QuestionViewTests(TestCase):
    ...
    def test_index_view_with_a_past_question(self):
        """
        Questions with a pub_date in past should be displayed on the index page.
        """
...
class QuestionIndexDetailTests(TestCase):
    ...
    def test_detail_view_with_a_future_question(self):
        """
        The detail view of a question with pub_date in the future should return a 404 not found.
        """
...
class QuestionMethodTests(TestCase):
    ...
    def test_was_published_recently_with_old_question(self):
        """
        was_published_recently() should return False for questions whose pub_date is older
        than 1 day.
        """
        time = timezone.now() - datetime.timedelta(days=30)
